...
export default function HowItWorksSection() {
    return (
        <section className="relative overflow-hidden bg-gradient-to-r from-gray-200 to-gray-50  ">
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 ">
                ...
                <div className="text-center mb-16  ">
                    <h2 className="text-xl uppercase mb-4 font-bold text-rose-500">How it works</h2>
...
function StepItem({icon,label,description}:Step){
    return <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border-white/10 hover:border-rose-500/50 transition-colors group w-full">
